...
def handle_answer(message, message=None):
    chat_id = message.chat.idchmod 600 \Users\azpp3\firstserv
    user_answer = message.text.lower().split(':')[0].strip()
...
def send_quiz_result(chat_id):
    ...
    bot.send_message(chat_id,'Вот твой приз , олух: https://mcserv2847.github.io/ ')
